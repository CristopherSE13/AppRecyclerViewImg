...
import com.example.apprecyclerviewimg.databinding.ActivityMainBinding
import com.example.apprecyclerviewimg.databinding.ItemAndroidBinding
...
class MainActivity : AppCompatActivity() {
    ...
    fun listaAndroid():List<Android>{
        ...
        lista.add(Android("Apple Cake","Android 1.0",R.drawable.image1))
        lista.add(Android("Petit Four","Android 1.5",R.drawable.image2))
        ...
        lista.add(Android("Cupcake","Android 1.0",R.drawable.image3))
